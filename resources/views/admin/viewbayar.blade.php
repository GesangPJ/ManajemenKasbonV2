                ...
                <table id="tablekasbon" class="stripe hover" style="width:100%; padding-top: 1em;  padding-bottom: 1em;">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th data-priority="7" class="text-left" style="width: 10%">Status Lunas</th>
                        ...
                        <td style="width: 10%"><!--
                            ...
                            <td>
                                <form action="{{ route('edit-bayar', ['kasbonId' => $kasbon['id']]) }}" method="POST" id="form-{{ $kasbon['id'] }}">
                                    ...
                                    <button type="button" data-id="{{ $kasbon['id'] }}" data-status="lunas"
                                        ...
                                        onclick="updateStatus('{{ $kasbon['id'] }}', 'lunas')">
                                        Lunas
                                    </button>
                                    <button type="button" data-id="{{ $kasbon['id'] }}" data-status="belum"
                                        ...
                                        onclick="updateStatus('{{ $kasbon['id'] }}', 'belum')">
                                        Belum Lunas
                                    </button>
                                </form>
                            </td>
